...
Declare.i   GetCursorPos (win, *x.Double, *y.Double) ; Get the position of the cursor in screen coordinates relative to the upper-left corner of the client area of the specified window.
Declare     SetCursorPos (win, x.d, y.d) ; Set the position of the cursor in screen coordinates relative to the upper-left corner of the client area of the specified window.
